                                                            ...
                                                            <div class="tab-pane fade show active" id="v-pills-home"
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <textarea name="meta_description" class="form-control max-height-140 meta-desc" cols="20" rows="4"> {!! $subcategory->metaData->meta_description ?? '' !!} </textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <textarea name="facebook_meta_description" class="form-control max-height-140 meta-desc" cols="20" rows="4">{!! $subcategory->metaData->facebook_meta_description ?? '' !!}</textarea>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <textarea name="twitter_meta_description" class="form-control max-height-140 meta-desc" cols="20" rows="4">{!! $subcategory->metaData->twitter_meta_description ?? '' !!}</textarea>
                                                                    </div>
                                                                </div>
