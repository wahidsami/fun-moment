                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <div class="single-input">
                                        <label for="ticketTitle" class="label_title">{{ __('Ticket title') }} <span class="text-danger">*</span> </label>
                                ...
                                <div class="col-12">
                                    <div class="single-input">
                                        <label for="ticketTitle" class="label_title">{{ __('Subject') }} <span class="text-danger">*</span> </label>
                                ...
                                <div class="col-12">
                                    <div class="single-input">
                                        <label for="ticketTitle" class="label_title">{{__('Select Order')}} <span class="text-danger">*</span> </label>
                                ...
                                <div class="col-12">
                                    <div class="single-input">
                                        <label for="ticketTitle" class="label_title">{{ __('Priority type') }} <span class="text-danger">*</span> </label>
                                        <div class="single-input-select radius-10">
