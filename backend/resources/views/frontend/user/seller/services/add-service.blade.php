                        ...
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                ...
                                <div class="notice-board mb-0" style="border-left:5px solid #9e9e9e !important;">
                                    <p class="text-secondary">{{__('This part is common for both of/on line services. After create service you will redirect a page where you will create service attributes for offline or online.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
