                                ...
                                <form action="{{route('seller.edit.services',$service->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="single-dashboard-input">
                                        <div class="single-info-input margin-top-30">
                                            <label for="category" class="info-title"> {{__('Select Parent Category')}} <span class="text-danger">*</span> </label>
                                                                ...
                                                                <div class="tab-pane fade show active" id="v-pills-home"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-md-12">
                                                                            ...
                                                                            <textarea name="meta_description" class="form-control max-height-140" cols="20"
                                                                ...
                                                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-md-12">
                                                                            ...
                                                                            <textarea name="facebook_meta_description" class="form-control max-height-140 meta-desc" cols="20"
