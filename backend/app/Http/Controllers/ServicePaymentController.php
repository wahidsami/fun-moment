...
{
    private bool $freshOrderPaymentUpdate = false;
    private bool $freshWalletDepositUpdate = false;
    ...
    {
        if (!$this->freshWalletDepositUpdate) {
            return;
        }
    ...
    private function update_wallet_database($last_deposit_id, $transaction_id, $history_id)
    {
        ...
        $this->freshWalletDepositUpdate = false;

        if (is_null($deposit_details)) {
            return;
        }
        ...
        $this->freshWalletDepositUpdate = true;
    ...
    {
        if (!$this->freshOrderPaymentUpdate) {
            return;
        }
    ...
    {
        $this->freshOrderPaymentUpdate = false;
        ...
        $this->freshOrderPaymentUpdate = true;
