...
----------------------------------------------------------------------------------------------------------------------------*/
    ...
    Route::get('/auth-check', 'AdminDashboardController@authCheck')->name('admin.auth.check');
    Route::get('/dashboard-summary', 'AdminDashboardController@dashboardSummary')->name('admin.dashboard.summary');
    Route::get('/settings-json', 'AdminDashboardController@settingsJson')->name('admin.settings.json');
    Route::post('/settings-json', 'AdminDashboardController@updateSettingsJson')->name('admin.settings.json.update');
    Route::get('/dark-mode-toggle', 'AdminDashboardController@dark_mode_toggle')->name('admin.dark.mode.toggle');
    Route::get('/feature-flags', 'AdminFeatureFlagController@index')->name('admin.feature.flags');
    Route::post('/feature-flags/{module}', 'AdminFeatureFlagController@update')->name('admin.feature.flags.update');
    Route::post('/feature-flags', 'AdminFeatureFlagController@bulkUpdate')->name('admin.feature.flags.bulk.update');
    Route::get('/frontend-users', 'FrontendUserManageController@apiUsers')->name('admin.frontend.users.api');
    Route::post('/frontend-users/{id}/status', 'FrontendUserManageController@apiUpdateUserStatus')->name('admin.frontend.users.status.api');
    ...
    Route::post('/services-json/{id}', 'ServiceController@apiUpdateService')->name('admin.services.update.api');
    Route::post('/services-json/bulk-status', 'ServiceController@apiBulkStatus')->name('admin.services.bulk.status.api');
    Route::post('/services-json/bulk-delete', 'ServiceController@apiBulkDelete')->name('admin.services.bulk.delete.api');
    Route::post('/services-json/{id}/status', 'ServiceController@apiUpdateServiceStatus')->name('admin.services.status.api');
    Route::post('/services-json/{id}/delete', 'ServiceController@apiDeleteService')->name('admin.services.delete.api');
    Route::get('/orders-json', 'OrdersController@apiOrders')->name('admin.orders.api');
    Route::post('/orders-json/{id}/status', 'OrdersController@apiUpdateOrderStatus')->name('admin.orders.status.api');
    Route::get('/orders-json/{id}', 'OrdersController@apiOrderDetails')->name('admin.orders.details.api');
    Route::get('/payments-json', 'OrdersController@apiPayments')->name('admin.payments.api');
    Route::post('/payments-json/{txnId}/refund', 'OrdersController@apiRefundPayment')->name('admin.payments.refund.api');
    ...
    Route::post('/cms-blogs/{id}', 'AdminCmsController@apiUpdateBlog')->name('admin.cms.blogs.update.api');
    Route::post('/cms-blogs/{id}/delete', 'AdminCmsController@apiDeleteBlog')->name('admin.cms.blogs.delete.api');
    Route::post('/cms-pages', 'AdminCmsController@apiStorePage')->name('admin.cms.pages.store.api');
    Route::post('/cms-pages/{id}', 'AdminCmsController@apiUpdatePage')->name('admin.cms.pages.update.api');
    Route::post('/cms-pages/{id}/delete', 'AdminCmsController@apiDeletePage')->name('admin.cms.pages.delete.api');
    Route::post('/cms-menus', 'AdminCmsController@apiStoreMenu')->name('admin.cms.menus.store.api');
    Route::post('/cms-menus/{id}', 'AdminCmsController@apiUpdateMenu')->name('admin.cms.menus.update.api');
    Route::post('/cms-menus/{id}/delete', 'AdminCmsController@apiDeleteMenu')->name('admin.cms.menus.delete.api');
    Route::post('/cms-menus/{id}/default', 'AdminCmsController@apiDefaultMenu')->name('admin.cms.menus.default.api');
    Route::post('/cms-widgets', 'AdminCmsController@apiStoreWidget')->name('admin.cms.widgets.store.api');
    Route::post('/cms-widgets/{id}', 'AdminCmsController@apiUpdateWidget')->name('admin.cms.widgets.update.api');
    Route::post('/cms-widgets/{id}/delete', 'AdminCmsController@apiDeleteWidget')->name('admin.cms.widgets.delete.api');
    Route::post('/cms-widgets/{id}/order', 'AdminCmsController@apiReorderWidget')->name('admin.cms.widgets.order.api');
    Route::get('/cms-media', 'AdminCmsController@apiMediaInventory')->name('admin.cms.media.api');
    Route::post('/cms-media/upload', 'AdminCmsController@apiUploadMedia')->name('admin.cms.media.upload.api');
    Route::post('/cms-media/{id}/delete', 'AdminCmsController@apiDeleteMedia')->name('admin.cms.media.delete.api');
    Route::post('/cms-media/{id}/alt', 'AdminCmsController@apiUpdateMediaAlt')->name('admin.cms.media.alt.api');
