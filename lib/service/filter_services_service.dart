...
import 'package:funmoments/model/service_search_model.dart';
...
import '../view/search/service_filter_molde.dart';
    ...
    if (responseData != null) {
      ...
      tempData.mainServices?.forEach((element) {
        setServiceList(
          ...
          calculateAverage(
              element.service?.reviewsForMobile?.map((e) => e.rating).toList()),
          element.imageUrl,
          1,
