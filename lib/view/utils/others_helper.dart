...
const String _defaultBaseApi = 'https://funmoments.sa/api/v1';
const String _defaultGoogleMapsApiKey = 'AIzaSyCa_4rCTW1k8PZ90yGmyhUyG9reXuPURiw';

String baseApi =
    const String.fromEnvironment('BASE_API', defaultValue: _defaultBaseApi);
...
String mapApiKey = const String.fromEnvironment(
  'GOOGLE_MAPS_API_KEY',
